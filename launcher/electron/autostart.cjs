...
const LINUX_DESKTOP_NAME = "dev.codexwebgpt.secure.launcher.desktop";
...
Type=Application
Version=1.0
Name=Codex Web GPT Secure
Comment=Start the Codex Web GPT Secure launcher in the background
